...
import props from './UObjectTimeline.props';
import styles from './UObjectTimeline.styles';

export class UObjectTimeline extends LitElement {
    ...
    */
    changeImage(year, index) {
        this.ul(index);
        this.dispatchEvent(new CustomEvent('u-object-timeline:change-image', { detail: { year }, composed: true }));
    }
...
window.customElements.define('u-object-timeline', UObjectTimeline);